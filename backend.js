...
app.post('/upload', upload.single('file'), (req, res, next) => {
    ...
    const file = req.file;
    // Rename the file 
    fs.rename(__dirname + "/src/assets/"+file.filename, __dirname + "/src/assets/"+req.body["username"], () => { 
...
io.on("connection", (socket) => {
    ...
    socket.on("register", (user) => {
        ...
        if (login_valid == 0)
        {
            ...
            fs.copyFile(__dirname + "/src/assets/default", __dirname + "/src/assets/"+user.username, ()=>{});
